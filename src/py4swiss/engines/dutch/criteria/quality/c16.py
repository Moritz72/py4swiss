...
class C16(QualityCriterion):
    """
    Implementation of the quality criterion C.16.

    FIDE handbook: "C Pairing Criteria | Quality Criteria | C.16"
    ...
    def get_weight(cls, player_1: Player, player_2: Player, zero: DynamicUint, bracket: Bracket) -> DynamicUint:
        ...
        the minimum score in the given bracket and their downfloats in the previous round. However, if one of the given
        ...
        # See C.6 for comparison. Note that, similar to C.12, unpaired players will downfloat.
        ...
        # See C.6 for comparison. Note that, similar to C.12, only the higher ranked player can downfloat.
