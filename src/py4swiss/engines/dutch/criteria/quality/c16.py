...
class C16(QualityCriterion):
    ...
    "minimize the score differences of players who receive the same downfloat as the previous
    round."
    """
    ...
    def get_weight(cls, player_1: Player, player_2: Player, zero: DynamicUint, bracket: Bracket) -> DynamicUint:
        ...
        # Note that, similar to C.12, unpaired players will downfloat.
        ...
        # See C.6 for comparison
        # Note that, similar to C.12, only the higher ranked player can downfloat.
