...
class TeamSection(BaseModel):
    ...
    def set_code(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid team code '{section}'", column=1)
        ...
        for i in range(36, len(line), 5):
            try:
                ...
                if bool(line[i:].strip()):
                    raise LineException(f"Incomplete team player starting rank '{line[i:]}'", column=i + 1)
                return
            ...
            try:
                ...
                raise LineException(f"Invalid team player starting rank '{section}'", column=i + 1)
