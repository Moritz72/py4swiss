...
class PlayerSection(BaseModel):
    ...
    def set_code(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid player code '{section}'", column=1)
    ...
    def set_starting_number(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid starting rank '{section}'", column=5)
    ...
    def set_sex(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid sex '{section}'", column=10)
    ...
    def set_title(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid title '{section}'", column=11)
    ...
    def set_fide_rating(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid fide rating '{section}'", column=53)
    ...
    def set_fide_number(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid fide number '{section}'", column=58)
    ...
    def set_birth_date(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid birth date '{section}'", column=70)
    ...
    def set_points_times_ten(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid points '{section}'", column=81)
    ...
    def set_rank(self, line: str) -> None:
        ...
        try:
            ...
            raise LineException(f"Invalid rank '{section}'", column=86)
        ...
        for i in range(89, len(line), 10):
            try:
                ...
                if bool(line[i:].strip()):
                    raise LineException(f"Incomplete round result '{line[i:]}'", column=i + 1)
                return
            ...
            try:
                ...
                raise LineException(f"Invalid round result '{section}'", column=i + 1)
